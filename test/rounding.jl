...
winnipeg = resolve("America/Winnipeg", tzdata["northamerica"][1:2]...)   # UTC-6:00 (or UTC-5:00)
st_johns = resolve("America/St_Johns", tzdata["northamerica"][1:2]...)   # UTC-3:30 (or UTC-2:30)
eucla = resolve("Australia/Eucla", tzdata["australasia"][1:2]...)        # UTC+8:45
colombo = resolve("Asia/Colombo", tzdata["asia"][1:2]...)                # See note below
